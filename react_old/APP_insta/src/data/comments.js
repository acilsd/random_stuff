const comments = {
  ...
  "BAF_KY4wcRY":[
    {
      "text":"Looking great! I'd like to see the other side of the room too.",
      "user": "axcdnt"
    },
    {
  ...
  "hZh6IQcfN":[
    {
      "text":"What do we gotta do to get some :)?",
      "user": "jonasbad"
    },
    {
      "text":"Might drop by today - real quick. Trade you an illegal pin for these? Lol",
      "user": "henrihelvetica"
    },
    {
